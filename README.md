...
* [(b) Register via Custom Invite](https://github.com/Abhishekpathania01/Check-Point-Labs/blob/master/technical_deep_dive/Exercise%201-Option-2:%20Register%20via%20Custom%20Invite.md#b-register-via-custom-invite)
